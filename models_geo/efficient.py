# Source: https://github.com/lukemelas/EfficientNet-PyTorch/blob/master/efficientnet_pytorch/model.py
...
class MaxPool2dDynamicSamePadding(nn.MaxPool2d):
  ...
  def __init__(self,
               ...
               ceil_mode=False):
    super().__init__(kernel_size, stride, padding, dilation, return_indices,
                     ceil_mode)
    ...
    self.dilation = [self.dilation] * 2 if isinstance(self.dilation,
                                                      int) else self.dilation
